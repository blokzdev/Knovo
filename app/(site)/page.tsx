  ...
  return (
    <main className="mx-auto max-w-5xl px-6">
      <section className="py-16 sm:py-24">
        ...
        <h1 className="mt-6 max-w-2xl text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl">
      ...
      <section className="pb-8">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-500">Recently published</h2>
        {items.length === 0 ? (
          <p className="mt-4 text-sm text-neutral-500">No published explainers yet — check back soon.</p>
        ) : (
