...
// Side drawer built on the Radix Dialog already in the project (no new dependency). Used for the
// mobile nav. Radix provides the focus trap, escape/overlay close, and scroll lock.
